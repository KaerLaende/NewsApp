...
public class CategoryController {
    ...
    public ResponseEntity<CategoryDto> createCategory(@Valid @RequestBody CreateCategoryDto categoryDto) {
        log.trace("Создание новой категории новостей");
    ...
    public ResponseEntity<List<CategoryDto>> getAllCategories() {
        ...
        log.trace("Запрос всех категорий");
        return ResponseEntity.ok(categoryService.findAllCategory());
    }

    @PatchMapping("/{id}")
    @Operation(summary = "Изменить название категории новостей")
    public ResponseEntity<CategoryDto> editCategory(@PathVariable("id") long id, @Valid @RequestBody CreateCategoryDto createCategoryDto) {
        log.trace("Редактирование категории новостей");
        return ResponseEntity.ok(categoryService.editCategory(id, createCategoryDto));
    }
